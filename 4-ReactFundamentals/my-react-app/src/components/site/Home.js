            ...
            <div className="main">
                <div className="mainDiv">
                    ...
                    <ul>
                        ...
                        <li>This app simply scratches the surface with what is possible with React.</li>
